...
public class DFDDiagramUpdater {
	...
	*/
	public static List<dFD.diagram.part.DFDLinkDescriptor> getContainedLinks(View view) {
		...
		case dFD.diagram.edit.parts.ProcesoEditPart.VISUAL_ID:
			return getProceso_2001ContainedLinks(view);
		case dFD.diagram.edit.parts.EntidadExternaEditPart.VISUAL_ID:
			return getEntidadExterna_2002ContainedLinks(view);
		case dFD.diagram.edit.parts.AlmacenEditPart.VISUAL_ID:
			return getAlmacen_2003ContainedLinks(view);
	...
	*/
	public static List<dFD.diagram.part.DFDLinkDescriptor> getIncomingLinks(View view) {
		switch (dFD.diagram.part.DFDVisualIDRegistry.getVisualID(view)) {
		case dFD.diagram.edit.parts.ProcesoEditPart.VISUAL_ID:
			return getProceso_2001IncomingLinks(view);
		case dFD.diagram.edit.parts.EntidadExternaEditPart.VISUAL_ID:
			return getEntidadExterna_2002IncomingLinks(view);
		case dFD.diagram.edit.parts.AlmacenEditPart.VISUAL_ID:
			return getAlmacen_2003IncomingLinks(view);
		case dFD.diagram.edit.parts.FlujoEditPart.VISUAL_ID:
	...
	*/
	public static List<dFD.diagram.part.DFDLinkDescriptor> getOutgoingLinks(View view) {
		switch (dFD.diagram.part.DFDVisualIDRegistry.getVisualID(view)) {
		case dFD.diagram.edit.parts.ProcesoEditPart.VISUAL_ID:
			return getProceso_2001OutgoingLinks(view);
		case dFD.diagram.edit.parts.EntidadExternaEditPart.VISUAL_ID:
			return getEntidadExterna_2002OutgoingLinks(view);
		case dFD.diagram.edit.parts.AlmacenEditPart.VISUAL_ID:
			return getAlmacen_2003OutgoingLinks(view);
		case dFD.diagram.edit.parts.FlujoEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public static List<dFD.diagram.part.DFDLinkDescriptor> getProceso_2001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dFD.diagram.part.DFDLinkDescriptor> getEntidadExterna_2002ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dFD.diagram.part.DFDLinkDescriptor> getAlmacen_2003ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dFD.diagram.part.DFDLinkDescriptor> getProceso_2001IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<dFD.diagram.part.DFDLinkDescriptor> getEntidadExterna_2002IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<dFD.diagram.part.DFDLinkDescriptor> getAlmacen_2003IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<dFD.diagram.part.DFDLinkDescriptor> getProceso_2001OutgoingLinks(View view) {
		dFD.Proceso modelElement = (dFD.Proceso) view.getElement();
		LinkedList<dFD.diagram.part.DFDLinkDescriptor> result = new LinkedList<dFD.diagram.part.DFDLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<dFD.diagram.part.DFDLinkDescriptor> getEntidadExterna_2002OutgoingLinks(View view) {
		dFD.EntidadExterna modelElement = (dFD.EntidadExterna) view.getElement();
		LinkedList<dFD.diagram.part.DFDLinkDescriptor> result = new LinkedList<dFD.diagram.part.DFDLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Flujo_4001(modelElement));
		return result;
	 ...
	 * @generated
	 */
	public static List<dFD.diagram.part.DFDLinkDescriptor> getAlmacen_2003OutgoingLinks(View view) {
		dFD.Almacen modelElement = (dFD.Almacen) view.getElement();
		LinkedList<dFD.diagram.part.DFDLinkDescriptor> result = new LinkedList<dFD.diagram.part.DFDLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Flujo_4001(modelElement));
		return result;

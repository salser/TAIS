 ...
 * @generated
 */
public class FlujoNombreEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FlujoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = dFD.diagram.providers.DFDParserProvider.getParser(dFD.diagram.providers.DFDElementTypes.Flujo_4001,
					getParserElement(),
					dFD.diagram.part.DFDVisualIDRegistry.getType(dFD.diagram.edit.parts.FlujoNombreEditPart.VISUAL_ID));
		}
		return parser;
	...
	*/
	protected IFigure createFigurePrim() {
		return new FlujoLabelFigure();
	}

	/**
	 * @generated
	 */
	public class FlujoLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public FlujoLabelFigure() {
			this.setText("Flujo");
		}

 ...
 * @generated
 */
public class ProcesoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ProcesoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new dFD.diagram.edit.policies.DFDTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return dFD.diagram.providers.DFDElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = dFD.diagram.providers.DFDParserProvider.getParser(
					dFD.diagram.providers.DFDElementTypes.Proceso_2001, getParserElement(),
					dFD.diagram.part.DFDVisualIDRegistry
							.getType(dFD.diagram.edit.parts.ProcesoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					dFD.diagram.edit.parts.DFDEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}

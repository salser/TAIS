 ...
 * @generated
 */
public class AlmacenNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AlmacenNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = dFD.diagram.providers.DFDParserProvider.getParser(
					dFD.diagram.providers.DFDElementTypes.Almacen_2003, getParserElement(),
					dFD.diagram.part.DFDVisualIDRegistry
							.getType(dFD.diagram.edit.parts.AlmacenNombreEditPart.VISUAL_ID));
		}
		return parser;
	}

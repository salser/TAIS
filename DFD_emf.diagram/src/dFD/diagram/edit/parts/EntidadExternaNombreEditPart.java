 ...
 * @generated
 */
public class EntidadExternaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EntidadExternaNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = dFD.diagram.providers.DFDParserProvider.getParser(
					dFD.diagram.providers.DFDElementTypes.EntidadExterna_2003, getParserElement(),

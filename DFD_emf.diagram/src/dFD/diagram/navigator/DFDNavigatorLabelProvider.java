...
public class DFDNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	...
	*/
	public Image getImage(View view) {
		...
		case dFD.diagram.edit.parts.DFDEditPart.VISUAL_ID:
			return getImage("Navigator?Diagram?http://javeriana.edu.co/dFD?DFD", //$NON-NLS-1$
					dFD.diagram.providers.DFDElementTypes.DFD_1000);
		case dFD.diagram.edit.parts.ProcesoEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://javeriana.edu.co/dFD?Proceso", //$NON-NLS-1$
					dFD.diagram.providers.DFDElementTypes.Proceso_2001);
		case dFD.diagram.edit.parts.EntidadExternaEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://javeriana.edu.co/dFD?EntidadExterna", //$NON-NLS-1$
					dFD.diagram.providers.DFDElementTypes.EntidadExterna_2002);
		case dFD.diagram.edit.parts.AlmacenEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://javeriana.edu.co/dFD?Almacen", //$NON-NLS-1$
					dFD.diagram.providers.DFDElementTypes.Almacen_2003);
		case dFD.diagram.edit.parts.FlujoEditPart.VISUAL_ID:
			return getImage("Navigator?Link?http://javeriana.edu.co/dFD?Flujo", //$NON-NLS-1$
	...
	*/
	public String getText(View view) {
		...
		case dFD.diagram.edit.parts.ProcesoEditPart.VISUAL_ID:
			return getProceso_2001Text(view);
		case dFD.diagram.edit.parts.EntidadExternaEditPart.VISUAL_ID:
			return getEntidadExterna_2002Text(view);
		case dFD.diagram.edit.parts.AlmacenEditPart.VISUAL_ID:
			return getAlmacen_2003Text(view);
		case dFD.diagram.edit.parts.FlujoEditPart.VISUAL_ID:
	...
	* @generated
	*/
	private String getProceso_2001Text(View view) {
	...
	* @generated
	*/
	private String getEntidadExterna_2002Text(View view) {
		IParser parser = dFD.diagram.providers.DFDParserProvider.getParser(
				dFD.diagram.providers.DFDElementTypes.EntidadExterna_2002,
	...
	* @generated
	*/
	private String getAlmacen_2003Text(View view) {
		IParser parser = dFD.diagram.providers.DFDParserProvider.getParser(
				dFD.diagram.providers.DFDElementTypes.Almacen_2003,
				view.getElement() != null ? view.getElement() : view,

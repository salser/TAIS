...
public class DFDParserProvider extends AbstractProvider implements IParserProvider {
	...
	* @generated
	*/
	private IParser almacenNombre_5001Parser;

	/**
	* @generated
	*/
	private IParser getAlmacenNombre_5001Parser() {
		if (almacenNombre_5001Parser == null) {
			...
			almacenNombre_5001Parser = parser;
		}
		return almacenNombre_5001Parser;
	}

	/**
	* @generated
	*/
	private IParser procesoNombre_5002Parser;

	/**
	* @generated
	*/
	private IParser getProcesoNombre_5002Parser() {
		if (procesoNombre_5002Parser == null) {
			EAttribute[] features = new EAttribute[] { dFD.DFDPackage.eINSTANCE.getElemento_Nombre() };
			dFD.diagram.parsers.MessageFormatParser parser = new dFD.diagram.parsers.MessageFormatParser(features);
			procesoNombre_5002Parser = parser;
		}
		return procesoNombre_5002Parser;
	}

	/**
	* @generated
	*/
	private IParser entidadExternaNombre_5003Parser;

	/**
	* @generated
	*/
	private IParser getEntidadExternaNombre_5003Parser() {
		if (entidadExternaNombre_5003Parser == null) {
			EAttribute[] features = new EAttribute[] { dFD.DFDPackage.eINSTANCE.getElemento_Nombre() };
			dFD.diagram.parsers.MessageFormatParser parser = new dFD.diagram.parsers.MessageFormatParser(features);
			entidadExternaNombre_5003Parser = parser;
		}
		return entidadExternaNombre_5003Parser;
	}

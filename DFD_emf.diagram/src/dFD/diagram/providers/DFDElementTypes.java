...
public class DFDElementTypes {
	...
	* @generated
	*/
	public static final IElementType Proceso_2001 = getElementType("DFD_emf.diagram.Proceso_2001"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType EntidadExterna_2002 = getElementType("DFD_emf.diagram.EntidadExterna_2002"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Almacen_2003 = getElementType("DFD_emf.diagram.Almacen_2003"); //$NON-NLS-1$
	/**
	* @generated
	*/
	...
	*/
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Proceso_2001, dFD.DFDPackage.eINSTANCE.getProceso());

			elements.put(EntidadExterna_2002, dFD.DFDPackage.eINSTANCE.getEntidadExterna());

			elements.put(Almacen_2003, dFD.DFDPackage.eINSTANCE.getAlmacen());
	...
	*/
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Proceso_2001);
			KNOWN_ELEMENT_TYPES.add(EntidadExterna_2002);
			KNOWN_ELEMENT_TYPES.add(Almacen_2003);

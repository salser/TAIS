 ...
 * @generated
 */
public class ArticuloImpl extends EObjectImpl implements Articulo {
	/**
		...
		if (proveedor != null && proveedor.eIsProxy()) {
			...
			if (proveedor != oldProveedor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DFDPackage.ARTICULO__PROVEEDOR, oldProveedor, proveedor));
			}
		}
		return proveedor;
	}
	...
	public void setProveedor(Proveedor newProveedor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DFDPackage.ARTICULO__PROVEEDOR, oldProveedor, proveedor));
	}

 ...
 * </p>
 * <ul>
 *   <li>{@link DFD.impl.ClienteImpl#getPedido <em>Pedido</em>}</li>
 *   <li>{@link DFD.impl.ClienteImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link DFD.impl.ClienteImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClienteImpl extends EObjectImpl implements Cliente {
	...
	protected EClass eStaticClass() {
		return DFDPackage.Literals.CLIENTE;
	}
	...
	public EList<Pedido> getPedido() {
		if (pedido == null) {
			pedido = new EObjectContainmentEList<Pedido>(Pedido.class, this, DFDPackage.CLIENTE__PEDIDO);
		}
		return pedido;
	}

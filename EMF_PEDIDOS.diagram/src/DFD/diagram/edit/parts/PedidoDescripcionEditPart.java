...
import DFD.diagram.edit.policies.DFDTextSelectionEditPolicy;
 ...
 * @generated
 */
public class PedidoDescripcionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PedidoDescripcionEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new DFDTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return DFDElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DFDParserProvider.getParser(DFDElementTypes.Pedido_2001, getParserElement(),
					DFDVisualIDRegistry.getType(DFD.diagram.edit.parts.PedidoDescripcionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, DFDEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}

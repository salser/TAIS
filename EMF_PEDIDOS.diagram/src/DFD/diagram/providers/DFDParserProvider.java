...
public class DFDParserProvider extends AbstractProvider implements IParserProvider {
	...
	* @generated
	*/
	private IParser pedidoDescripcion_5001Parser;

	/**
	* @generated
	*/
	private IParser getPedidoDescripcion_5001Parser() {
		if (pedidoDescripcion_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { DFDPackage.eINSTANCE.getPedido_Descripcion() };
			MessageFormatParser parser = new MessageFormatParser(features);
			pedidoDescripcion_5001Parser = parser;
		}
		return pedidoDescripcion_5001Parser;
	}
	...
	*/
	protected IParser getParser(int visualID) {
		switch (visualID) {
		case PedidoDescripcionEditPart.VISUAL_ID:
			return getPedidoDescripcion_5001Parser();
		}
		return null;
	}

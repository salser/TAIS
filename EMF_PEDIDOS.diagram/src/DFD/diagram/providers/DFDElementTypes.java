...
public class DFDElementTypes {
	...
	* @generated
	*/
	public static final IElementType Cliente_1000 = getElementType("EMF_PEDIDOS.diagram.Cliente_1000"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Pedido_2001 = getElementType("EMF_PEDIDOS.diagram.Pedido_2001"); //$NON-NLS-1$
	...
	*/
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Cliente_1000, DFDPackage.eINSTANCE.getCliente());

			elements.put(Pedido_2001, DFDPackage.eINSTANCE.getPedido());
		}
	...
	*/
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Cliente_1000);
			KNOWN_ELEMENT_TYPES.add(Pedido_2001);
		}

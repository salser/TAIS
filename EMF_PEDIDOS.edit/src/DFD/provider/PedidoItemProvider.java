		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DFDPackage.Literals.PEDIDO__ID,
				 false,
				 false,
				 false,
	...
	protected void addDescripcionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pedido_descripcion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pedido_descripcion_feature", "_UI_Pedido_type"),
				 DFDPackage.Literals.PEDIDO__DESCRIPCION,
				 false,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DFDPackage.Literals.PEDIDO__ARTICULO,
				 DFDFactory.eINSTANCE.createArticulo()));
	}

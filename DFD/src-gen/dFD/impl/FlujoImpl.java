...
public class FlujoImpl extends MinimalEObjectImpl.Container implements Flujo {
	...
	public Elemento getAnterior() {
		if (anterior != null && anterior.eIsProxy()) {
			...
			if (anterior != oldAnterior) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DFDPackage.FLUJO__ANTERIOR, oldAnterior,
							anterior));
			}
		}
		return anterior;
	...
	public Elemento getSiguiente() {
		if (siguiente != null && siguiente.eIsProxy()) {
			...
			if (siguiente != oldSiguiente) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DFDPackage.FLUJO__SIGUIENTE, oldSiguiente,
							siguiente));
			}
		}
		return siguiente;
	...
	public void setSiguiente(Elemento newSiguiente) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DFDPackage.FLUJO__SIGUIENTE, oldSiguiente,
					siguiente));
	}

...
/**
 * This is the item provider adapter for a {@link DFD.Pedido} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PedidoItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DFDPackage.Literals.PEDIDO__ID, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
						null, null));
	}
	...
	protected void addDescripcionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Pedido_descripcion_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Pedido_descripcion_feature",
								"_UI_Pedido_type"),
						DFDPackage.Literals.PEDIDO__DESCRIPCION, true, false, false,
	...
	protected void addEstadoPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Pedido_estado_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Pedido_estado_feature", "_UI_Pedido_type"),
						DFDPackage.Literals.PEDIDO__ESTADO, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DFDPackage.Literals.PEDIDO__ARTICULO);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(DFDPackage.Literals.PEDIDO__ARTICULO, DFDFactory.eINSTANCE.createArticulo()));
	}
